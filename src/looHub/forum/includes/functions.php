...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
	...
	$template->assign_vars(array(
		...
		'SITE_LOGO_IMG'			=> $user->img('site_logo'),
                ...
                'M_ITEM_1'                      => append_sid("{$phpbb_root_path}viewforum.$phpEx?f=" . LOO_HUB_FORUM_ID),
                'M_ITEM_2'                      => append_sid("{$phpbb_root_path}viewforum.$phpEx?f=" . REVIEWS_FORUM_ID),
                'M_ITEM_3'                      => append_sid("{$phpbb_root_path}viewforum.$phpEx?f=" . ADVICE_FORUM_ID),
                'M_ITEM_4'                      => append_sid("{$phpbb_root_path}viewforum.$phpEx?f=" . XCURRIC_FORUM_ID),
                'M_ITEM_5'                      => append_sid("{$phpbb_root_path}viewforum.$phpEx?f=" . MARKET_FORUM_ID),
                'M_ITEM_6'                      => append_sid("{$phpbb_root_path}viewforum.$phpEx?f=" . ARCADE_FORUM_ID),
